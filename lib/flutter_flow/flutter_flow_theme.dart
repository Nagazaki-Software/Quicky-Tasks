...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primaryText = const Color(0xFF171A1E);
  late Color secondaryText = const Color(0xFFB49874);
  late Color primaryBackground = const Color(0xFFFFF1DE);
  late Color secondaryBackground = const Color(0xFF242424);
  late Color accent1 = const Color(0xFFFFE8C9);
  ...
  late Color info = const Color(0xDFFFFFFF);

  late Color customColor1 = const Color(0x412B323B);
  late Color customColor2 = const Color(0xFF484B51);
}
