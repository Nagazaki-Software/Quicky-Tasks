...
import 'ratings_taskees_copy_model.dart';
export 'ratings_taskees_copy_model.dart';

class RatingsTaskeesCopyWidget extends StatefulWidget {
  const RatingsTaskeesCopyWidget({super.key});

  static String routeName = 'RatingsTaskeesCopy';
  static String routePath = '/ratingsTaskeesCopy';

  @override
  State<RatingsTaskeesCopyWidget> createState() =>
      _RatingsTaskeesCopyWidgetState();
}

class _RatingsTaskeesCopyWidgetState extends State<RatingsTaskeesCopyWidget> {
  late RatingsTaskeesCopyModel _model;
