                                  ...
                                  onTap: () async {
                                    ...
                                    await currentUserReference!.update({
                                      ...createUsersRecordData(
                                        ...
                                        photoUrl: _model
                                            .uploadedFileUrl_uploadDataSf7u34,
                                        taskOrTaskee: 'Taskee',
                    ...
                    InkWell(
                      ...
                      onTap: () async {
                        ...
                        if (selectedMedia != null &&
                          ...
                          safeSetState(() =>
                              _model.isDataUploading_uploadDataSf7u34 = true);
                          ...
                          try {
                            ...
                            _model.isDataUploading_uploadDataSf7u34 = false;
                          }
                          if (selectedUploadedFiles.length ==
                                  selectedMedia.length &&
                              downloadUrls.length == selectedMedia.length) {
                            safeSetState(() {
                              _model.uploadedLocalFile_uploadDataSf7u34 =
                                  selectedUploadedFiles.first;
                              _model.uploadedFileUrl_uploadDataSf7u34 =
                                  downloadUrls.first;
                            });
                          } else {
                            safeSetState(() {});
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Stack(
                              children: [
                                if (_model.uploadedFileUrl_uploadDataSf7u34 !=
                                        '')
                                  Container(
                                    width: 200.0,
                                    height: 200.0,
                          ...
                          StreamBuilder<List<ComunitysRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<ComunitysRecord>
                                  containerComunitysRecordList = snapshot.data!;
                          ...
                          child: Row(
                            ...
                            children: [
                              FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'CREATE_PROFILE_PAGE_google_ICN_ON_TAP');
                                  ...
                                  await currentUserReference!.update({
                                    ...createUsersRecordData(
                                      clienteStripeId: getJsonField(
                                        (_model.accountStripep?.jsonBody ?? ''),
                                        r'''$.accountId''',
                                      ).toString(),
                                    ),
                                    ...mapToFirestore(
                              ...
                              FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'CREATE_PROFILE_PAGE_apple_ICN_ON_TAP');
                                  logFirebaseEvent('IconButton_auth');
                                  GoRouter.of(context).prepareAuthEvent();
                                  final user = await authManager
