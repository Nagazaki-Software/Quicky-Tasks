...
export 'email_tasker_model.dart';

class EmailTaskerWidget extends StatefulWidget {
  const EmailTaskerWidget({super.key});

  static String routeName = 'emailTasker';
  static String routePath = '/emailTasker';

  @override
  State<EmailTaskerWidget> createState() => _EmailTaskerWidgetState();
}

class _EmailTaskerWidgetState extends State<EmailTaskerWidget> {
  late EmailTaskerModel _model;
