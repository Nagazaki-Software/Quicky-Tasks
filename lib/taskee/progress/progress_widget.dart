...
import '/components/taskfinish_widget.dart';
                                ...
                                FutureBuilder<UsersRecord>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'PROGRESS_PAGE_Row_kozqrf4s_ON_TAP');
                                        logFirebaseEvent('Row_navigate_to');

                                        context.pushNamed(
                                          PerfildosusersWidget.routeName,
                                          queryParameters: {
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'PROGRESS_PAGE_Container_dx8lo5s7_ON_TAP');
                                        logFirebaseEvent(
                                        ...
                                        await progressTasksRecord
                                            .usuarioQueAceitouaTask!
                                            .update({
                                          ...mapToFirestore(
                                            {
                                              'quantTasksRealizadas':
                                              ...
                                              'saldo': FieldValue.increment(
                                                  functions.quantodetokentem(
                                                      stackTasksPreProntasRecord
                                                          .preco)),
                                              'saldoALiberar': FieldValue.increment(
                                                  -(functions.quantodetokentem(
                                                      stackTasksPreProntasRecord
                                                          .preco))),
                                            },
