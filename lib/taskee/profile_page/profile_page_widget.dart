                        ...
                        children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    child: custom_widgets
                                                      ...
                                                      onSwitch:
                                                          (onOrNot) async {
                                                        logFirebaseEvent(
                                                            'PROFILE_Container_j7h5ka04_CALLBACK');
                                                        if (onOrNot) {
                                                          logFirebaseEvent(
                                        ...
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'PROFILE_PAGE_PAGE_Column_jzp8ymba_ON_TAP');
                                            logFirebaseEvent(
                                                'Column_navigate_to');

                                            context.pushNamed(
                                                EditarperfildousuariotaskerWidget
                                                    .routeName);
                                          },
                                          child: Column(
                                            mainAxisSize: MainAxisSize.max,
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'PROFILE_ContainerBalance_ON_TAP');
                                logFirebaseEvent(
                                    'ContainerBalance_widget_animation');
                                if (animationsMap[
                                ...
                                logFirebaseEvent(
                                    'ContainerBalance_navigate_to');

                                context
                                    .pushNamed(QuickySolutionsWidget.routeName);
                              },
                              child: Container(
                                width: double.infinity,
                                height: 40.0,
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'PROFILE_Container_thox45e9_ON_TAP');
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 6.0, 0.0, 0.0),
                                child: Text(
                                  'Best options for tasker and taskee',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        font: GoogleFonts.poppins(
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'PROFILE_PAGE_PAGE_Column_gkif6d0z_ON_TAP');
                                            logFirebaseEvent(
                                                'Column_navigate_to');

                                            context.pushNamed(
                                                EditarperfildousuariotaskeeWidget
                                                    .routeName);
                                          },
                                          child: Column(
                                            mainAxisSize: MainAxisSize.max,
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                ...
                                context.pushNamed(
                                    QuickySolutionsCopyWidget.routeName);
                              },
                              child: Container(
                                width: double.infinity,
                                height: 40.0,
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'PROFILE_Container_iwdmtj04_ON_TAP');
                                    logFirebaseEvent('Container_bottom_sheet');
                                    await showModalBottomSheet(
                                      isScrollControlled: true,
                                      backgroundColor: Colors.transparent,
