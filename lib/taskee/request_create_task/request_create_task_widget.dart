...
class _RequestCreateTaskWidgetState extends State<RequestCreateTaskWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'RequestCreateTask'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('REQUEST_CREATE_TASK_RequestCreateTask_ON');
      logFirebaseEvent('RequestCreateTask_custom_action');
                                            ...
                                            Theme(
                                              ...
                                              child: Checkbox(
                                                value: _model.checkboxValue1 ??=
                                                    () {
                                                  if (!_model.meOrTasker) {
                                                    return true;
                                                  } else                                                  return false;
                                                
                                                }(),
                                                onChanged: _model.meOrTasker
                                                    ? null
                                                    : (newValue) async {
                                                        safeSetState(() => _model
                                                                .checkboxValue1 =
                                                        ...
                                                        if (newValue!) {
                                                          logFirebaseEvent(
                                                              'REQUEST_CREATE_TASK_Checkbox_qu9g6b09_ON');
                                                          logFirebaseEvent(
                                                    ...
                                                    child: Checkbox(
                                                      ...
                                                      onChanged: !_model
                                                          ...
                                                          : (newValue) async {
                                                              ...
                                                              if (newValue!) {
                                                                logFirebaseEvent(
                                                                    'REQUEST_CREATE_TASK_Checkbox_rwg076kg_ON');
                                                                logFirebaseEvent(
                                                                    'Checkbox_update_page_state');
                                                                _model.meOrTasker =
                                                                    true;
                                      ...
                                      builder: (context) {
                                        ...
                                        return SingleChildScrollView(
                                          ...
                                          child: Row(
                                            mainAxisSize: MainAxisSize.max,
                                            children:
                                                List.generate(materials.length,
                                                    (materialsIndex) {
                                              final materialsItem =
                                        ...
                                        Container(
                                          ...
                                          child: custom_widgets.TimeList30Min(
                                            ...
                                            onTimeSelected:
                                                (selectedTime) async {
                                              logFirebaseEvent(
                                                  'REQUEST_CREATE_TASK_Container_mccg39aq_C');
                                              logFirebaseEvent(
                                                  'TimeList30Min_update_page_state');
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'REQUEST_CREATE_TASK_Container_3n3zvist_O');
                                                        logFirebaseEvent(
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'REQUEST_CREATE_TASK_Container_m7hira71_O');
                                                        logFirebaseEvent(
                                                            'Container_update_page_state');
                                                        _model.fastPass = 1;
                                                        safeSetState(() {});
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'REQUEST_CREATE_TASK_Container_h7pfiaem_O');
                                                        logFirebaseEvent(
                                                            'Container_update_page_state');
                                                        _model.fastPass = 2;
                                                        safeSetState(() {});
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'REQUEST_CREATE_TASK_Container_0tjkvf3i_O');
                                                        logFirebaseEvent(
                                                            'Container_update_page_state');
                                                        _model.fastPass = 3;
                                                        safeSetState(() {});
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'REQUEST_CREATE_TASK_Icon_yya30f6x_ON_TAP');
                          ...
                          child: FutureBuilder<TasksPreProntasRecord>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              return InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'REQUEST_CREATE_TASK_Container_jrx3lsfi_O');
                                  ...
                                  await tasksRecordReference.set({
                                    ...createTasksRecordData(
                                      ...
                                      descricao: containerTasksPreProntasRecord
                                          .descricao,
                                      categoria: containerTasksPreProntasRecord
                                          .categoria,
                                      avaliado: false,
                                      datadecriacaodatask: getCurrentTimestamp,
                                    ),
                                    ...mapToFirestore(
                                      {
                                  ...
                                  if (valueOrDefault(
                                        ...
                                        return GestureDetector(
                                          ...
                                          child: Padding(
                                            ...
                                            child: MoneyToDeposityTaskeeWidget(
                                              buy: true,
                                              token: functions.quantodetokentem(
                                                  containerTasksPreProntasRecord
                                                      .preco),
                                            ),
                                          ),
                                    ...
                                    await _model.taskDocument!.reference
