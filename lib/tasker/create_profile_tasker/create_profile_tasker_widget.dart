...
class CreateProfileTaskerWidget extends StatefulWidget {
  const CreateProfileTaskerWidget({super.key});

  static String routeName = 'createProfileTasker';
  static String routePath = '/createProfileTasker';

  @override
  State<CreateProfileTaskerWidget> createState() =>
                      ...
                      children: [
                        InkWell(
                          ...
                          onTap: () async {
                            ...
                            _model.clicou = true;
                            safeSetState(() {});
                            logFirebaseEvent('Icon_request_permissions');
                            ...
                            await currentUserReference!.update({
                              ...createUsersRecordData(
                                ...
                                clienteStripeId: getJsonField(
                                  (_model.accountStriper?.jsonBody ?? ''),
                                  r'''$.accountId''',
                                ).toString(),
                                verifyaccount: false,
                                comunnity: _model.dropDownValue,
                              ),
                              ...mapToFirestore(
                                {
                                  'saldo': FieldValue.increment(21.0),
                                  'plataform':
                                      FieldValue.arrayUnion(['Quicky Tasks']),
                                },
                              ),
                            });
                  ...
                  InkWell(
                    ...
                    onTap: () async {
                      ...
                      if (selectedMedia != null &&
                        ...
                        safeSetState(
                            () => _model.isDataUploading_uploadDataSfu = true);
                        ...
                        try {
                          ...
                          _model.isDataUploading_uploadDataSfu = false;
                        }
                        if (selectedUploadedFiles.length ==
                                selectedMedia.length &&
                            downloadUrls.length == selectedMedia.length) {
                          safeSetState(() {
                            _model.uploadedLocalFile_uploadDataSfu =
                                selectedUploadedFiles.first;
                            _model.uploadedFileUrl_uploadDataSfu =
                                downloadUrls.first;
                          });
                        } else {
                          safeSetState(() {});
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Stack(
                            children: [
                              if (_model.uploadedFileUrl_uploadDataSfu != '')
                                Container(
                                  width: 200.0,
                                  height: 200.0,
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      isDense: true,
                                      hintText:
                                          ' Insert a passwork you\'ll remeber....\n',
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                            font: GoogleFonts.poppins(
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'CREATE_PROFILE_TASKER_google_ICN_ON_TAP');
                                ...
                                context.goNamedAuth(SwipeTaskerWidget.routeName,
                                    context.mounted);
                            ...
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'CREATE_PROFILE_TASKER_apple_ICN_ON_TAP');
                                logFirebaseEvent('IconButton_auth');
                                GoRouter.of(context).prepareAuthEvent();
                                final user =
