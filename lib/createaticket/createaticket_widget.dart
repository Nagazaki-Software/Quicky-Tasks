...
import 'createaticket_model.dart';
export 'createaticket_model.dart';

/// crie uma pagina de ticket support
class CreateaticketWidget extends StatefulWidget {
  const CreateaticketWidget({super.key});

  static String routeName = 'createaticket';
  static String routePath = '/createaticket';
...
class _CreateaticketWidgetState extends State<CreateaticketWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'createaticket'});
                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 4.0, 0.0, 0.0),
                                                child: Text(
                                                  'Add screenshots or documents that may help (max 10MB)',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodySmall
                                                      .override(
