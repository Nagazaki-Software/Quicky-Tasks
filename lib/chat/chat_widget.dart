                                    ...
                                    return Row(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'CHAT_PAGE_Icon_9atxnbqc_ON_TAP');
                                            logFirebaseEvent(
                                                'Icon_navigate_back');
                                            context.safePop();
                                          },
                            ...
                            child: StreamBuilder<List<ChatHistoryRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                return ListView.separated(
                                  ...
                                  itemCount:
                                      listViewChatHistoryRecordList.length,
                                                      ...
                                                      builder:
                                                        ...
                                                        return Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            Text(
                                                              'Waiting for response from Tasker.',
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          ...
                                          triggerPushNotification(
                                            ...
                                            notificationText:
                                                '${currentUserDisplayName} sent you a new message, come in to see.',
