...
class _ChatCopyWidgetState extends State<ChatCopyWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'ChatCopy'});
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'CHAT_COPY_PAGE_Icon_9di6sd0y_ON_TAP');
                            ...
                            children: [
                              Align(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'CHAT_COPY_CircleImage_50tid59n_ON_TAP');
                                    logFirebaseEvent(
                                    ...
                                    Flexible(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          if (stackUsersRecord.dob != null)
                                            Text(
                                              '${stackUsersRecord.comunnity} • ${stackUsersRecord.eitnia} • ${valueOrDefault<String>(
                                                functions
                                          ...
                                          if (stackUsersRecord.dob == null)
                                            Text(
                                              '${stackUsersRecord.comunnity} • ${valueOrDefault<String>(
                                                stackUsersRecord.eitnia,
                              ...
                              Builder(
                                builder: (context) {
                                  final taskscompleted =
                                      stackUsersRecord.tasksCompleted.toList();

                                  return Column(
                                    mainAxisSize: MainAxisSize.max,
                                    children:
                                        List.generate(taskscompleted.length,
                                            (taskscompletedIndex) {
                                      final taskscompletedItem =
                                          taskscompleted[taskscompletedIndex];
                                      return FutureBuilder<TasksRecord>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          final flippableCardTasksRecord =
                                              snapshot.data!;
